...
//            frecuencias = CargarDatos.cargarFrecuencias(CargarParametros.getArchivoFrecuencia());
//            tramos = CargarDatos.cargarTramos(CargarParametros.getArchivoTramo());
//        } catch (Exception e) {
//            throw new RuntimeException(e);
//        }
    ...
    void testpParametrosLoades(){
        assertEquals("tramo_PM.txt", CargarParametros.getArchivoTramo());
        assertEquals("linea_PM.txt", CargarParametros.getArchivoLinea());
        assertEquals("parada_PM.txt", CargarParametros.getArchivoParada());
        assertEquals("frecuencia_PM.txt", CargarParametros.getArchivoFrecuencia());
    }
